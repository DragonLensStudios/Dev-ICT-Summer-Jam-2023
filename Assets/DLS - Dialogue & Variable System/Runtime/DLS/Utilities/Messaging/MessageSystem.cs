...
namespace DLS.Utilities
{
    public static class MessageSystem
    {
        ...
        {
            private static readonly Dictionary<MessageChannels, List<Delegate>> _channels = new ();
            private static readonly ConcurrentDictionary<MessageChannels, ConcurrentQueue<IMessageEnvelope>> _messageQueues = new ();
            private static readonly ConcurrentDictionary<MessageChannels, int> _priorities = new ();
